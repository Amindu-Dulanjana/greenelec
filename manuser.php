        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-2">
                <div class="row">
                    ...
                    <div class="col-2 bg-primary pt-2 pb-2 d-lg-block d-none">
                ...
                <div class="col-12 mb-2">
                    <div class="row">
                        ...
                        <div class="col-2 bg-light d-none d-lg-block">
                            <?php
                            $img = Database::search("SELECT * FROM `profile_img` WHERE `user_email`='" . $srow["email"] . "'");
                            $imgn = $img->num_rows;
                            if ($imgn == 1) {
                                $imgr = $img->fetch_assoc();
                            ?>
                                <img src="<?php echo $imgr['code']; ?>" style="height: 70px; margin-left: 100px;" />
                            <?php
                            } else {
                            ?>
                    ...
                    <div class="col-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-4 col-lg-1 bg-white pt-2 pb-2 d-grid">
                                ...
                                ?>
                                    <button id="blockbtn" class="btn btn-success" onclick="blockuser('<?php echo $srow['email']; ?>');">Unblock</button>
                                <?php
                                }
