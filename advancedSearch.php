            ...
            <!-- <div class="offset-o offset-lg-2 col-12 col-lg-8 bg-white mt-3 mb-3 rounded">
                <div class="row">
                    ...
                    <div class="col-3 col-lg-2 mb-2 mt-2">
                        <select class=" form-select border border-2 border-dark border-start-0 border-end-0 border-top-0" id="sort" onclick="advancedSearch(0);">
                        <option value="0"><i class="bi bi-funnel-fill">Sort Results</i></option>
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="row g-1">
                                                                        <div class="col-12 col-lg-6 d-grid">
                                                                            <a href="#" class="btn btn-success" onclick="sendID(<?php echo $productImage['id'] ?>);">Buy Now</a>
                                                                        </div>
                                                                        <div class="col-12 col-lg-6 d-grid">
                                                                            <a href="#" class="btn btn-danger" onclick="deleteModal(<?php echo $productImage['id'] ?>);">Add Card</a>
                                                                        </div>
                                                                    </div>
